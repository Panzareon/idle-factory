  ...
  internal class EnergyGridTests
  {
    ...
    public void CalculateLaserHitMirrorTest()
    {
      ...
      Assert.That(grid.CalculatedLaser, Is.EquivalentTo([
        new Laser(emitter.Direction, new Vector2(0, 0), new Vector2(0, 1), 0, emitter.LaserStrength),
        new Laser(new Vector2(1, 0), new Vector2(0, 1), new Vector2(3, 1), 0, emitter.LaserStrength),]));
    }
  }
}
